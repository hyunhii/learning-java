...
public class ProductOrderMain3 {
    ...
    public static void main(String[] args) {
        ...
        printProductOrders(orders);
        System.out.println("총 결제 금액:" + printTotalAmount(orders));
    }
    ...
    static void printProductOrders(ProductOrder[] orders) {
        for (ProductOrder order : orders) {
            System.out.println("상품명: " + order.productName + ", 가격: " + order.price + ", 수량: " + order.quantity);
        }
    }

    static int printTotalAmount(ProductOrder[] orders) {
        int totalAmount = 0;
